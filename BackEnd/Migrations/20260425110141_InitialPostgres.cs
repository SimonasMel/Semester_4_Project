        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FuelConsumptionLitersPer100Km = table.Column<double>(type: "double precision", nullable: true),
                    EnergyConsumptionKWhPer100Km = table.Column<double>(type: "double precision", nullable: true),
                    Price = table.Column<decimal>(type: "numeric", nullable: false),
                    MileageKm = table.Column<int>(type: "integer", nullable: false),
                    PrimaryImagePath = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    AdditionalImagePaths = table.Column<List<string>>(type: "text[]", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredPrice = table.Column<decimal>(type: "numeric", nullable: true),
                    ...
                    UsePrice = table.Column<bool>(type: "boolean", nullable: false),
                    UseMileage = table.Column<bool>(type: "boolean", nullable: false),
                    UseEnginePower = table.Column<bool>(type: "boolean", nullable: false),
                    UseFuelType = table.Column<bool>(type: "boolean", nullable: false),
                    UseTransmission = table.Column<bool>(type: "boolean", nullable: false),
                    UseBodyType = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
